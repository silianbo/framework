package com.lb.framework.web.servlet.json;
...
public class WebJsonUtil extends JsonUtil {
     ...
     * 必须在接受HTTP请求时使用，这样才能获得当前HTTP请求，并且在非HTTP请求时，也没有转换JSONP字符串的必要</br> JSONP字符串不能再进行反序列化操作
     * 
     ...
     * @see com.sfpay.framework2.web.servlet.HttpServletHolder
     */
    public static final String toJSONPString(HttpServletRequest request,
                                             String text) {
